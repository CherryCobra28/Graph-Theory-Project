...
\begin{document}
    ...
    \section{Mathematical Methods}
        \subsection{Scale-Free Graphs}
        Scale-Free Graphs follow a power law, that is $p_{k} \sim k^{-\gamma}$ where $p_{k}$ is the probability of having degree $k$. We will now show the discrete formalism of the power law.
        \begin{proof}
            \begin{align*}
