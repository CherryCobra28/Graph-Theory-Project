...
\begin{document}
    ...
    \section{Literature Review}
        ...
        \section{Analysis}
            ...
            \subsection{SIRD Model differences}
                \subsubsection{SIRD Model Parameters}
                ...
                \subsubsection{Time Taken To Complete}
                From our $N = 2500$ run of $400$ random graphs and $400$ Barabási-Albert graphs, random graphs had a average time to complete of $17.2$ with a standard deviation of $1.06$ andd barabsi graphs had a mean of $15.727$ and standrad deviation of $0.659$. A two smaple t test of these averages to see if there was a difference was done at the 5\% significance level, it foudn there was a significant difference between the two graphs in theri time to complete.
                \subsubsection{Survivors}
                Using the same sample we found that the average number of suvivors for the random graphs was $1499.4$ with a standard deviation of $25.2$ and for barabasi graphs they had an average of $1500.3$ with standard deviation of $25$. A two sample t test determined that thier was no significantly difference in the number of surviors of the infection hinting that the casulaty rate was independetn of graph structure and more likely correlated with the parameters of the model.
