...
\title{Structural Differences in Random and Small World, Scale-Free Graphs }
\date{08/02/2023}
    ...
    \section{Mathematical Methods}
        ...
        \begin{proof}
            \begin{align*}
                ...
                &\therefore p_{k}=\frac{k^{-\gamma}}{\zeta(\gamma)}
            \end{align*}
            Therefore the average degree of a scale-free graph is:
            \begin{align*}
                &\overline{k} = \sum_{k=1}^{\infty}kp_{k}\\
                &\therefore \overline{k} = \sum_{k=1}^{\infty}k\frac{k^{-\gamma}}{\zeta(\gamma)}\\
            \end{align*}
            ...
            \begin{align*}
                ...
                &\therefore p(k) = (\gamma -1)k_{\text{min}}^{\gamma-1}k^{-\gamma}\\
        ...
        \end{align*}
        Now the interpretation of these moemnts are important. $n=1$ is evidently our expected degree as shown above. $n=2$ allows us to calulate the variance of the degree distrubution via the formula: $\sigma^2 = \langle k^2 \rangle - \langle k\rangle ^2$. $n=3$ gives us the skewness of the degree distrubution.
